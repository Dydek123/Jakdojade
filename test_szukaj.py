...
class WyszukiwainieTest(unittest.TestCase):
    ...
    def test_sprawdz_point_id(self):
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_point_id, 0)
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_point_id, "84")
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.sprawdz_point_id, ("spam",))

    def test_point_id_to_stop_name(self):
        self.assertEqual(self.wyszukiwarka.point_id_to_stop_name(7413), ['Biprostal'])
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.point_id_to_stop_name, 0)
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.point_id_to_stop_name, "spam")
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.point_id_to_stop_name, ("84",))

    def test_sprawdz_variant_id(self):
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_variant_id, 745334)
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.sprawdz_variant_id, ['spam'])
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.sprawdz_variant_id, [0])

    def test_sprawdz_both_variant_id(self):
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_both_variant_id, 745334, 7413)
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_both_variant_id, [745334], 7413)
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.sprawdz_both_variant_id, 745334, [7413])

    def test_zamien_id_na_nr_linii(self):
        self.assertEqual(self.wyszukiwarka.zamien_id_na_nr_linii(("spam",)), [])
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.zamien_id_na_nr_linii, 25)
    ...
    def test_ktory_przystanek_linii(self):
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.ktory_przystanek_linii, 113, 1085738)
        self.assertRaises(szukaj.BrakPrzystankuException, self.wyszukiwarka.ktory_przystanek_linii, [113], [1085738])
    ...
    def test_rzutuj_na_int(self):
        ...
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.rzutuj_na_int, 2)
        self.assertRaises(ValueError, self.wyszukiwarka.rzutuj_na_int, ['2', 'str'])

    def test_szukaj_wszystkie_drogi(self):
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.szukaj_wszystkie_drogi, 2098, 12076)
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.szukaj_wszystkie_drogi, ['2', 'st'], ['1235', '1207'])

    def test_wybierz_unikalne(self):
        self.assertEqual(self.wyszukiwarka.wybierz_unikalne([[['12', '15'], ['12', '15']]]), [['15', '12']])
        self.assertRaises(szukaj.ZlaFormaArgumentow, self.wyszukiwarka.wybierz_unikalne, [['12', '15'], ['12']])
